...
![Onglet click-and-collect](images-gestion-click-and-collect/image1.png)

- Cliquez sur **« Voir la commande »**
- La page web s'ouvre avec le détail de la demande

![Détail de la commande](images-gestion-click-and-collect/image2.png)

**Comment vérifier si l'article est en stock ?**

Sur ODEIS, cliquez sur **Interro** :

![ODEIS — Interro](images-gestion-click-and-collect/image3.png)

Dans **Ancienne Référence**, indiquez la référence WEB :

![ODEIS — champ référence](images-gestion-click-and-collect/image4.png)
...
![Étape préparation](images-gestion-click-and-collect/image5.png)
