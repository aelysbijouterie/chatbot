...
![Icône de l'application commandes web](images/image1.png)
...
![Pop-up commande en attente](images/image2.png)
...
![Animation de chargement](images/image3.png)

Si la fenêtre charge en continu sans s'arrêter, faites un **clic droit → Actualiser** :

![Clic droit Actualiser](images/image4.png)
...
![Page de connexion interface web](images/image5.png)
...
![Écrins web et enveloppes bulles pour la lettre suivie](images/image6.jpeg)
![Écrins web et enveloppes bulles — vue 2](images/image7.jpeg)
...
![Application E-Réservation](images/image8.png)
