module.exports = async function(req, res) {
  ...
  try {
    ...
    // ── Base documentaire ──────────────────────────────────────
    // Schéma de chaque fiche dans kb.json :
    // {
    //   "id": "sav-creation-fiche",
    ...
    //   "pdfUrl": "https://raw.githubusercontent.com/.../sav/creation-fiche-sav.pdf",
    //   "dateMAJ": "2026-05-12"
    // }
    ...
    function score(question, doc) {
      ...
      const keywordWords = new Set(
        (doc.motsClefs || []).flatMap(k => tokenize(k))
      );
